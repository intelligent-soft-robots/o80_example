...
state.set(50)
frontend.add_command(0, state, o80.Iteration(start_iteration), o80.Mode.OVERWRITE)
frontend.add_command(1, state, o80.Iteration(start_iteration), o80.Mode.OVERWRITE)
...
for _ in range(30):
    ...
    state.set(v1)
    frontend.add_command(1, state, o80.Iteration(target_iteration), o80.Mode.QUEUE)
